...
<div class="form">
    <form method="POST" action="lab3.php">
        <fieldset>
            ...
            <legend>Дані Аккаунту</legend>
            <label for="login">Логін:</label><br>
            <input type="text" id="login" name="login" placeholder="Створіть свій логін" required><br>
            ...
            <label for="password">Створіть свій пароль:</label><br>
